...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        JMenu mnewcustomer = new JMenu("New Customer");
        mnewcustomer.setForeground(Color.BLUE);
        ...
        mnewcustomer.add(newcustomer);
        
        JMenu mcustomerdetails = new JMenu("Customer Details");
        mcustomerdetails.setForeground(Color.BLUE);
        ...
        mcustomerdetails.add(customerdetails);
        
        JMenu mdepositdetails = new JMenu("Deposit Details");
        mdepositdetails.setForeground(Color.BLUE);
        ...
        mdepositdetails.add(depositdetails);
        
        JMenu mcalculatebill = new JMenu("Calculate Bill");
        mcalculatebill.setForeground(Color.BLUE);
        ...
        mcalculatebill.add(calculatebill);
       ...
       JMenu mnewadmin = new JMenu("Add New Admin");
        mnewadmin.setForeground(Color.BLUE);
        
        /*JMenu master = new JMenu("Master");
        master.setForeground(Color.BLUE);*/
        
        JMenuItem newadmin = new JMenuItem("Add New Admin");
        newadmin.setFont(new Font("monospaced", Font.PLAIN, 12));
        newadmin.setBackground(Color.WHITE);
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/icon1.png"));
        Image image10 = icon10.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        newadmin.setIcon(new ImageIcon(image10));
        newadmin.setMnemonic('A');
        newadmin.addActionListener(this);
        newadmin.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, ActionEvent.CTRL_MASK));
        mnewadmin.add(newadmin);
        ...
        if (atype.equals("Admin")) {
            mb.add(mnewcustomer);
            mb.add(mcustomerdetails);
            mb.add(mdepositdetails);
            mb.add(mcalculatebill);
            mb.add(mnewadmin);
        } else {
            mb.add(info);
            mb.add(user);
        ...
        if (msg.equals("New Customer")) {
            ...
            try{
                ...
                if(rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No bills to be paid");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
