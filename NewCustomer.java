...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer() {
        ...
        errMessage = new JLabel("No error");
        errMessage.setBounds(180, 45, 200, 16);
        errMessage.setFont(new Font("Tahoma", Font.PLAIN, 14));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            if (!(address.isEmpty()) && !(meter.isEmpty()) && !(name.isEmpty()) && !(city.isEmpty()) && !(state.isEmpty()) && !(email.isEmpty()) && !(phone.isEmpty())){
                ...
                if( isNumeric(phone) &&phone.length()==10){
                    ...
                    errMessage.setText("Enter valid phone number");
                    errMessage.setVisible(true);
                }
            
            } else{
                errMessage.setText("Enter valid details");
                errMessage.setVisible(true);
                }
            }else {
            setVisible(false);
